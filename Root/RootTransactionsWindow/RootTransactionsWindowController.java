...
public class RootTransactionsWindowController {
    ...
    void addNewTransactionClick(ActionEvent event) {
        ...
        Parent root=null;
        try {
            root=fxmlLoader.load(getClass().getResource("/sample/Root/RootAddTransactionWindow/RootAddTransactionWindow.fxml").openStream());
        } catch (IOException e) {
            e.printStackTrace();
        }

        RootAddTransactionWindowController rootAddTransactionWindowController=(RootAddTransactionWindowController) fxmlLoader.getController();

        rootAddTransactionWindowController.setStage(primaryStage);
rootAddTransactionWindowController.setCompanyname(current_companyname);
        rootAddTransactionWindowController.setUsername(username);

        primaryStage.setTitle("Добавление предприятия");
        Scene scene = new Scene(root);
        scene.getStylesheets().add("sample/Root/RootAddTransactionWindow/style.css");
    ...
    public void showPieChart(ActionEvent actionEvent) {
        if (transactionCurrent_field==null){
            ...
            Parent root = null;
            try {
                root = fxmlLoader.load(getClass().getResource("/sample/Root/RootPieChart/RootPieChart.fxml").openStream());
            } catch (IOException e) {
                e.printStackTrace();
            }

            RootPieChartController rootPieChartController = (RootPieChartController) fxmlLoader.getController();
            rootPieChartController.setStage(primaryStage);
            rootPieChartController.setup(primaryStage,current_transname,current_companyname);
